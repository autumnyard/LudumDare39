...
public class ManagerInput : MonoBehaviour
{
	...
	public delegate void DelegateBool( bool condition );
	public DelegateBool OnInputDown;
	public DelegateBool OnInputUp;
	#endregion
		...
		if( !Director.Instance.isPaused )
		{
            ...
            */
			...
			if( Director.Instance.currentScene == Structs.GameScene.Ingame )
			{
				...
				{
					//Debug.Log( "Pressing something." );
					Director.Instance.DebugPlayerMoving( true );
				}
				else
				{
					Director.Instance.DebugPlayerMoving( false );
				}
			}
		}
