...
public class EntityBase : MonoBehaviour
{
	...
	protected bool canDash = true; // LDJAM39
	...
	private Vector3 tweenAppearScaleFinish = new Vector3( .5f, .5f );//Vector3.one;
	...
	private void PlayAnimationAppearing()
	{
		...
		// Play animation, when it is finished change state to Normal
		float scaleInit = tweenAppearScaleBegin.x;
		float scaleFinish = tweenAppearScaleFinish.x;
		float time = 0.4f;
